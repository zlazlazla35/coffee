...
import { faChevronDown, faBookmark, faRegular } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="liset_page">
            ...
            <div className="list_card">
                <div className="list_card_top">
                    ...
                    <div>
                        <FontAwesomeIcon icon={faRegular} size="xs" />
                        <FontAwesomeIcon icon="faRegular fa-bookmark" />
                    </div>
                </div>
            </div>
        </div>
