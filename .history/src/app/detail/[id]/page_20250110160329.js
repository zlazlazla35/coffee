...
export default async function Detail(props) {
    ...
    let resultName = await db.collection('list').findOne({ _id: new ObjectId('677e4e238042eb3d6d7a2947') });
            ...
            <div className="detail_inner">
                ...
                <div className='contents'>
                    ...
                    <div className='contentText'>
                        고민내용 적혀있는곳 고민내용 적혀있는곳고민내용 적혀있는곳고민내용 적혀있는곳고민내용 적혀있는곳고민내용 적혀있는곳
                    </div>
                </div>
            </div>
